...
| ------------------------- | -------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| **Release identity**      | full SHA·web/API/jobs digest 검증 도구 구현                                            | 세 구성요소 모두 SHA `7c1336bc7985ea7e383c335d631b7c705fffb97c`; web `sha256:7dca740d6d7161fc57a14a0cc79a8488e25a12cf2c0ea37f8cd677188c13e267`, API revision `api-as-m098047--p07c1336bc` / `sha256:b43991c120161b73737d492847bd2c3e8dbb6fe33408e4ac49fac6fa01de13a7`, jobs `sha256:7918fa5fc0f207e11cc7b22c0a340cb40926369265c622085bab27bddf132ecc` | 이 범주는 완료; 이후 변경은 새 full-SHA/digest 증거가 필요                                       |
...
| **Release review**        | exact-SHA 기반 deterministic release-review v2 구현                                    | 도구는 `7c1336bc` 배포에 포함됐지만 실제 Security·Accessibility·OneRAI·Release 승인은 없음                                                                                                                                                                                                                                                            | 실행된 증거 bundle과 네 human decision 필요                                                      |
