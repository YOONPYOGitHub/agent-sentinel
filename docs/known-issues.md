...
| KI-009 | Service Tree record has no valid IcM node                  | Microsoft Entra rejects API and SPA app registration attribution with `Service not found` | Onboard the service to IcM and allow up to one day for propagation              |
