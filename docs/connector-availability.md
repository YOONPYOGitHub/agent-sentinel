...
permission was assigned. `Connected` means the bounded read path has evidence;
it does not imply exact cross-source correlation unless the row explicitly says
