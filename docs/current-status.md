...
| ---------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| Corporate Microsoft Entra activation                                         | The Service Tree record exists, but it has no valid IcM node. Entra rejects its service management reference.  | Onboard the service to IcM, allow propagation, then create both app registrations. |
