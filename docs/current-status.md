...
| Universal adapters                     | Exact object correlation and runtime verification are implemented. Typed comparison of supported non-runtime claim values remains; free-form claims stay unverified.                                                                       |
