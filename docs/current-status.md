...
| Azure Monitor measured windows               | Query health is ready and 6 benign spans were ingested across 6 agents. Drift and economics remain `insufficient-data` because the baseline has 0 samples and the minimum population is 10.        |
