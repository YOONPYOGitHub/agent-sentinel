...
| Runtime telemetry activation                 | The workspace exists, but the application UAMI has no Log Analytics query role and no validated agent spans are present. RBAC and instrumentation require a separate approved change.                                                                         |
