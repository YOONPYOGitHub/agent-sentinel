...
export const driftAnalysisResultSchema = z.object({
  ...
  computedAt: z.iso.datetime(),
  baselineWindowId: z.string().max(200).optional(),
  observedWindowId: z.string().max(200).optional(),
  baselineEvidenceId: z.string().max(200).optional(),
  observedEvidenceId: z.string().max(200).optional(),
