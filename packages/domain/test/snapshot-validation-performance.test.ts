    ...
    otel: {
      ...
      invocations: Array.from({ length: invocationCount }, (_, invocationIndex) => ({
        ...
        provenance: {
          ...
          providerResourceId: `/subscriptions/example/resource-${suffix}`,
          providerAgentId,
          traceId: invocationIndex.toString(16).padStart(32, '0'),
          spanId: invocationIndex.toString(16).padStart(16, '0'),
          observedAt: generatedAt,
          classification: 'live',
